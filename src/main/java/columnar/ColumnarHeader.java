...
public class ColumnarHeader extends DirectoryHFPage {
  ...
  public AttrType[] getColumns() throws IOException
      , HFBufMgrException, InvalidSlotNumberException, InvalidPageNumberException {
  ...
  private IndexInfo convertIndexByteInfo(byte[] byteinfo)
      throws IOException, InvalidSlotNumberException, HFBufMgrException, InvalidPageNumberException {
  ...
  public IndexInfo getIndex(int columnNum, IndexType indType)
      throws IOException,
      HFBufMgrException,
      InvalidSlotNumberException, InvalidPageNumberException {
  ...
  public AttrType getColumn(int i) throws IOException
      , InvalidSlotNumberException, HFBufMgrException, InvalidPageNumberException {
