...
import columnar.InvalidTupleSizeException;
import diskmgr.Page;
...
public class ColumnSortScan implements GlobalConst {
    ...
    public Tuple getNext(RID rid) throws InvalidTupleSizeException, IOException, heap.InvalidTupleSizeException {
    ...
    private boolean firstDataPage() throws IOException, InvalidTupleSizeException,
    						heap.InvalidTupleSizeException, HFException, HFBufMgrException, HFDiskMgrException {
        DataPageInfo dpInfo;
        Tuple recTuple = null;
        Boolean bst;
         heapFile = new Heapfile(heapfilename + "s" + "2" + "r" + "3");
        dirPageId.pid = 
        ...
        /**
         * ASSERTIONS: - first directory page pinned
    ...
    private boolean nextDataPage()
            ...
            IOException, heap.InvalidTupleSizeException {
    ...
    private boolean mvNext(RID rid) throws IOException, InvalidTupleSizeException, heap.InvalidTupleSizeException {
        RID nextRID;
        boolean status;
