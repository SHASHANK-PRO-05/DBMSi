...
public class ColumnarFileTest {
    ...
    public void creationColumnar() throws Exception {
        ...
        SystemDefs systemDefs = new SystemDefs(dbPath, 3000, 400, "LRU");
...
//        columnarFile = new ColumnarFile("Employee");
        ...
        // IndexInfo info1 = columnarFile.getColumnarHeader().getIndex(12, new
        // IntegerValue(4), new IndexType(1) );
...
//		System.out.println(info3.getValue().getValue());
        ...
        // SystemDefs.JavabaseBM.unpinPage(columnarFile.getColumnarHeader().getHeaderPageId(),
        // false);
        // SystemDefs.JavabaseBM.flushAllPages();
