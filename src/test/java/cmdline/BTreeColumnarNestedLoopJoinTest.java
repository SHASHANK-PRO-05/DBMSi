...
public class BTreeColumnarNestedLoopJoinTest {
    ...
    public void setupDatabase() throws Exception {
        ...
        people.add(new Person(1, "Shikhar", 25));
        people.add(new Person(3, "Aanchal", 25));
    ...
    @Test
    public void bTreeNestedLoopJoin() throws Exception {
	String programArgumentsStr = String.format("%s %s pid BITMAP", columnarDBName, columnarOuterFileName);
	String[] programArgs = programArgumentsStr.split(" ");
	Index.main(programArgs);
	String programArgumentsString = String.format("%s %s %s [ pid == 1 ] [ eid == 1 ] [ pid == eid ] BITMAP [ pid name ] 100",
